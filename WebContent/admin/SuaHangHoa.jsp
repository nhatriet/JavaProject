			...
			<div class="card card-bg shadow boder" style="background: #d9d1a1; ">
			 ...
			 <a href="#" class="btn rounded-pill "  class="btn py-3 px-5 rounded-pill" style="background-color: #d4a762; color:#ac0c14;font-size: 20px">X</a>
                ...
                <div class="card-body p-4 p-xl-6">
                  <h2 class="text-100 text-center " >SỬA HÀNG HÓA</h2>
                  ...
                  <form>
                   <div class="row " >
                    ...
                    <div class="col-12 d-grid"> 
                    	<button  class="btn py-3 px-5 rounded-pill" style="background-color: #d4a762;" type="submit" onclick="getSelectedStatus()"><h5> Sửa <i class="fas fa-arrow-right ps-2"></i></h5></button>
